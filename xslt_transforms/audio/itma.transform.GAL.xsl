<xsl:stylesheet version="1.0" 
	...
	<xsl:template match="record">
		<mods:mods>
			...
			<!--	<mods:abstract/>	-->
			<xsl:if test="Notes">
				<mods:abstract><xsl:value-of select="Notes"/></mods:abstract>
			</xsl:if>	
	...
	<xsl:template name="Genre">
		<mods:genre authority="aat" type="Concept" displayLabel="Format" authorityURI="http://vocab.getty.edu/aat/" valueURI="http://vocab.getty.edu/aat/300028640">cylinders (sound recordings)</mods:genre>
	</xsl:template>
	...
	<xsl:template name="getRelatedItems">		
		...
		<mods:relatedItem type="constituent" ID="DMD_cylinder01">
			<mods:titleInfo>
				<xsl:choose>
